...
export default class AsaCampaignsBulkStatus extends Command {
    ...
    static override description = 'Progress board of one bulk operation: counts, pipelines and the per-object log';
    static override enableJsonFlag = true;
    static override examples = ['<%= config.bin %> asa campaigns bulk-status 660e8400-e29b-41d4-a716-446655440001'];
