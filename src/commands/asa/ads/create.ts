...
export default class AsaAdsCreate extends Command {
    static override description = 'Create an ad from a creative in an ad group';
    static override enableJsonFlag = true;
    static override examples = ['<%= config.bin %> asa ads create --ad-group UUID --creative-id 4321 --name "Summer ad"'];
