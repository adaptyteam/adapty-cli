...
export default class AsaConnect extends Command {
    static override description = 'Connect an Apple Search Ads account to this company';
    static override enableJsonFlag = true;
    static override examples = ['<%= config.bin %> asa connect', '<%= config.bin %> asa connect --no-wait'];
