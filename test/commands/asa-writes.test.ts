...
describe('asa writes', () => {
    ...
    it('campaigns carry target CPA and bidding strategy when asked', async () => {
        ...
        // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access -- FIXME if you see this
    ...
    it('keywords add reads a file and merges it with --text', async () => {
        ...
        // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access -- FIXME if you see this
        const body = JSON.parse(fetchStub.getCall(0).args[1].body as string);
        // eslint-disable-next-line @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access -- FIXME if you see this
